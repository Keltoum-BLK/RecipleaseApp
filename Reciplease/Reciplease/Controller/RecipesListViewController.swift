...
extension RecipesListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.timeTitle.text = Tool.shared.getDoubleToString(number: recipeSearch[indexPath.row].recipe?.totalTime)
        cell.likeTitle.text = Tool.shared.getDoubleToString(number: recipeSearch[indexPath.row].recipe?.yield)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        recipeDetailsVC.recipedetailsView.likeTitle.text = Tool.shared.getDoubleToString(number: recipeSearch[indexPath.row].recipe?.yield)
        recipeDetailsVC.recipedetailsView.timeTitle.text = Tool.shared.getDoubleToString(number: recipeSearch[indexPath.row].recipe?.totalTime)
